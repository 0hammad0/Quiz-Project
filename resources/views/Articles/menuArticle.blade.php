                                        ...
                                        @foreach ($series as $ser)
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="{{ url('/article/show', $ser->id) }}"
                ...
                <div class="card">
                    <div class="card-header p-3 pt-2">
                        ...
                        <div class="text-end pt-1">
                            <h4 class="mb-0">Article Types</h4>
                        </div>
                    </div>
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-3">
                        <p class="mb-0"><a href="{{ url('/article/type/show') }}"
                                class="text-success text-sm font-weight-bolder">View</a>
                    </div>
                </div>
            </div>
        </div>
